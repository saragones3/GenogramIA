...
3. Ejecutar el comando `./gradlew :composeApp:run` para validar que la aplicación se ejecuta correctamente en Desktop.
4. **Fidelidad Visual**: Comparar el resultado final con los diseños en `.agents/screens` para asegurar que se han respetado los espaciados, colores y reglas del sistema de diseño.
